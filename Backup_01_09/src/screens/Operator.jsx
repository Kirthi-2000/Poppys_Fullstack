    ...
    const csv = [
      ...
      ...filtered.map((row, idx) =>
        [
          ...
          row.sewingSpeed,
          row.stitchCount,
          row.pieceCount, // ✅ ADD PIECE COUNT TO CSV
        ].join(",")
      ),
    ].join("\n");
        ...
        <tbody>
          ${filtered
            ...
            <tr>
              ...
              <td>${row.pieceCount}</td> <!-- ✅ ADD PIECE COUNT TO HTML -->
            </tr>
          `
            )
            .join("")}
              ...
              {paginated.length === 0 ? (
                ...
                paginated.map((row, idx) => (
                  <tr key={idx}>
                    ...
                    <td>{row.sewingSpeed}</td>
                    <td>{row.stitchCount}</td>
                    <td>{row.pieceCount}</td> {/* ✅ ADD PIECE COUNT TO TABLE */}
                  </tr>
                ))
              )}
            </tbody>
    ...
    <div className="machine-root">
      ...
      {showRawData ? (
        ...
        <>
                  ...
                  {loading ? (
                    ...
                    paginated.map((row, idx) => (
                      <tr key={idx}>
                        ...
                        <td style={{ textAlign: 'center', padding: '8px' }}>{row.pieceCount}</td> {/* ✅ ADD PIECE COUNT TO TABLE */}
                      </tr>
                    ))
                  )}
                </tbody>
          ...
          {/* ✅ FIXED: Tiles Row - Use 5 tiles with piece count */}
