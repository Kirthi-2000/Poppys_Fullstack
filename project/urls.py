...
urlpatterns = [
    path('si_log/', PoppysMachineLogListView.as_view(), name='poppys-machine-log-list'), # API - POSTMAN 
    ...
    path('machine-id-suggest/', MachineIdSuggestView.as_view(), name='machine-id-suggest'),
    path('operator-id-suggest/', OperatorIdSuggestView.as_view(), name='operator-id-suggest'),
    path('line-id-suggest/', LineIdSuggestView.as_view(), name='line-id-suggest'),
